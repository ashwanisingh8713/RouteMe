 ...
 */
package com.google.ar.core.examples.navigation.helpers

import android.app.Activity
import android.widget.Toast
import androidx.lifecycle.DefaultLifecycleObserver
import androidx.lifecycle.LifecycleOwner
import com.ar.common.helpers.CameraPermissionHelper
...
//      Session(activity, features)
      Session(activity, EnumSet.of(Session.Feature.SHARED_CAMERA))
    } catch (e: Exception) {
