...
public final class SnackbarHelper {
  ...
  public void showMessage(Activity activity, String message) {
    if (!message.isEmpty() && (!isShowing() || !lastMessage.equals(message))) {
      lastMessage = message;
      showArError(activity, message, DismissBehavior.HIDE);
    }
  }

  /** Shows a snackbar with a given message, and a dismiss button. */
  public void showMessageWithDismiss(Activity activity, String message) {
    showArError(activity, message, DismissBehavior.SHOW);
  }
  ...
  public void showError(Activity activity, String errorMessage) {
    showArError(activity, errorMessage, DismissBehavior.FINISH);
  }

    public void showMsg(Activity activity, String errorMessage) {
        showArMsg(activity, errorMessage);
    }
