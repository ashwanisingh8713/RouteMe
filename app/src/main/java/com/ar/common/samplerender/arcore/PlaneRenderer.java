 ...
 */
package com.ar.common.samplerender.arcore;

import android.opengl.Matrix;

import com.ar.common.samplerender.IndexBuffer;
import com.ar.common.samplerender.Mesh;
import com.ar.common.samplerender.SampleRender;
import com.ar.common.samplerender.Shader;
import com.ar.common.samplerender.Texture;
import com.ar.common.samplerender.VertexBuffer;
...
//      Log.e("Ashwani", "PlaneRenderer.java :: drawPlanes() :: distance = "+distance);
    ...
    for (SortablePlane sortedPlane : sortedPlanes) {
      ...
      // Without this Plane is rendered in white surface
      shader.setMat4("u_Model", modelMatrix);

      // Without this Plane graph is not rendered only dots points shows
